...
import com.example.SolanaPOC.utils.bip32.crypto.Hash;
import com.example.SolanaPOC.utils.bip32.crypto.HdUtil;
import com.example.SolanaPOC.utils.bip32.crypto.HmacSha512;
import com.example.SolanaPOC.utils.bip32.crypto.Secp256k1;
...
import com.example.SolanaPOC.utils.bip32.wallet.key.SolanaCurve;
...
public class HdKeyGenerator {
    ...
    public com.example.SolanaPOC.utils.bip32.wallet.HdAddress getAddressFromSeed(byte[] seed, SolanaCoin solanaCoin) {

        SolanaCurve curve = solanaCoin.getCurve();
        HdPublicKey publicKey = new HdPublicKey();
        HdPrivateKey privateKey = new HdPrivateKey();
        com.example.SolanaPOC.utils.bip32.wallet.HdAddress address = new com.example.SolanaPOC.utils.bip32.wallet.HdAddress(privateKey, publicKey, solanaCoin, MASTER_PATH);
    ...
    public com.example.SolanaPOC.utils.bip32.wallet.HdAddress getAddress(com.example.SolanaPOC.utils.bip32.wallet.HdAddress parent, long child, boolean isHardened) {
        HdPrivateKey privateKey = new HdPrivateKey();
        HdPublicKey publicKey = new HdPublicKey();
        com.example.SolanaPOC.utils.bip32.wallet.HdAddress address = new HdAddress(privateKey, publicKey, parent.getCoinType(),
