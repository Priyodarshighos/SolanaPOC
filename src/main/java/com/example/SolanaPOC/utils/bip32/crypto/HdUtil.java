package com.example.SolanaPOC.utils.bip32.crypto;
...
public class HdUtil {
    ...
    public static byte[] getFingerprint(byte[] keyData) {
        byte[] point = com.example.SolanaPOC.utils.bip32.crypto.Secp256k1.serP(Secp256k1.point(HdUtil.parse256(keyData)));
